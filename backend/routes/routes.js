...
router.get("/star/:star_id", star_controller.get_star_by_id);
router.delete("/star/:star_id", star_controller.delete_star_by_id);
...
router.get("/constellation/:constellation_id", constellation_controller.get_constellation_by_id);
router.delete("/constellation/:constellation_id", constellation_controller.delete_constellation_by_id);
